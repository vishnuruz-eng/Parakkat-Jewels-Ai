    ...
    >
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        <h1 className="text-5xl font-extrabold tracking-tight text-gray-100 sm:text-6xl md:text-7xl">
          AI-Powered Jewelry Photo <span className="text-red-400">Generator Tool</span>
        </h1>
        ...
        <div className="mt-6 flex flex-col items-center gap-4 w-full">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md sm:max-w-none">
                ...
                <label htmlFor="single-image-upload" className="relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-red-600 rounded-full cursor-pointer group hover:bg-red-700 transition-colors w-full sm:w-auto">
                    <UploadIcon className="w-6 h-6 mr-3" />
                    Upload Single Image
                </label>
                <input id="single-image-upload" type="file" className="hidden" accept="image/*" onChange={handleFileChange} />

                {/* Batch Edit Upload Button */}
                <label htmlFor="batch-image-upload" className="relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-gray-200 bg-gray-700 rounded-full cursor-pointer group hover:bg-gray-600 transition-colors w-full sm:w-auto">
                    <UploadIcon className="w-6 h-6 mr-3" />
                    Upload Multiple Images (Batch)
                </label>
                <input id="batch-image-upload" type="file" className="hidden" accept="image/*" onChange={handleFileChange} multiple />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-full mb-4">
                       <MagicWandIcon className="w-6 h-6 text-red-400" />
                    </div>
                ...
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-full mb-4">
                       <PaletteIcon className="w-6 h-6 text-red-400" />
                    </div>
                ...
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-full mb-4">
                       <SunIcon className="w-6 h-6 text-red-400" />
                    </div>
